...
import GetSenderAddress from "./sender-address";

describe("Enter Sender Address", () => {
  let props;
  ...
  it("renders without crashing", () => {
    ...
    renderer.render(<GetSenderAddress {...props} />);
  ...
  it("snapshots to match", () => {
    const component = renderer.create(<GetSenderAddress {...props} />);
  ...
  it("render CaptureAddressForm with correct title", () => {
    ...
    expect(view.props.title).toEqual("Enter Sender's Address");
  });
});
